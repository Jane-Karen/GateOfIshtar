 ...
 * Date: 19 March 2018
 * 
 * Description: This Human class is used to accommodate all the activities which are to be done by the Champion-Human.
 * 
 */
...
public class Human extends Thread {
	...
	//Function to be called when Human has to meet the Council
	static void meetCouncil() {
		SimpleDateFormat simpleDateformat = new SimpleDateFormat("HH:mm:ss");
		Date date = new Date();

		System.out.println("Human Met Council " + "HH:MM:SS :: " + simpleDateformat.format(date) + " HP :: " + get_hp());
	}
	...
	public void run() {
		...
		System.out.println("Human Running : " + "HH:MM:SS :: " + " HP :: " + get_hp());
	...
	public void callEnemy() {
		...
		BrandThread = new Brand(1);
		MithraThread = new Mithra(1);
		KhaleesiThread = new Khaleesi(1);
